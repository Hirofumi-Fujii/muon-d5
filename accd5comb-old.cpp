...
void setup (const std::string& datsetname)
{
	...
	g_xpos [5] = -halfshift;
	g_xpos [4] =  halfshift;
	g_xpos [3] =  0.0 + g_xdiff;
	g_xpos [2] =  0.0 + g_xdiff;
	g_xpos [1] = -halfshift + g_xdiff;
	g_xpos [0] =  halfshift + g_xdiff;

	g_ypos [7] = -halfshift;
	g_ypos [6] =  halfshift;
	g_ypos [5] =  0.0;
	g_ypos [4] =  0.0;
	g_ypos [3] = -halfshift + g_ydiff;
	g_ypos [2] =  halfshift + g_ydiff;
	g_ypos [1] =  0.0 + g_ydiff;
	g_ypos [0] =  0.0 + g_ydiff;
