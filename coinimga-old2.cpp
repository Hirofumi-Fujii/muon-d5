...
static const int NUM_HIST2D = 19;
mylibrary::Hist2D hist2d [NUM_HIST2D] =
{
	...
	mylibrary::Hist2D ("dx-dy", -482.5, 482.5, NUM_XBINS, -482.5, 482.5, NUM_YBINS),
	mylibrary::Hist2D ("dx-dy smooth", -482.5, 482.5, NUM_XBINS, -482.5, 482.5, NUM_YBINS, true),
	mylibrary::Hist2D ("dxEO-dxOE", -482.5, 482.5, NUM_XBINS, -482.5, 482.5, NUM_XBINS),
	mylibrary::Hist2D ("dxEE-dxOO", -482.5, 482.5, NUM_XBINS, -482.5, 482.5, NUM_XBINS),
	mylibrary::Hist2D ("dyEO-dyOE", -482.5, 482.5, NUM_YBINS, -482.5, 482.5, NUM_YBINS),
	mylibrary::Hist2D ("dyEE-dyOO", -482.5, 482.5, NUM_YBINS, -482.5, 482.5, NUM_YBINS),
	mylibrary::Hist2D ("dxEO-dyEO", -482.5, 482.5, NUM_XBINS, -482.5, 482.5, NUM_XBINS),
	mylibrary::Hist2D ("dxEO-dyOE", -482.5, 482.5, NUM_XBINS, -482.5, 482.5, NUM_XBINS),
	mylibrary::Hist2D ("dxOE-dyEO", -482.5, 482.5, NUM_YBINS, -482.5, 482.5, NUM_YBINS),
	mylibrary::Hist2D ("dxOE-dyOE", -482.5, 482.5, NUM_YBINS, -482.5, 482.5, NUM_YBINS),
	mylibrary::Hist2D ("looze dxEO-dyEO", -482.5, 482.5, NUM_XBINS, -482.5, 482.5, NUM_XBINS),
};
					    ...
					    (recstr.substr(0,4) == "COIN"))
					{
						...
						if ((ss >> coinrec))
						{
							    ...
							    coinrec.B1cluster(uidy2, maxhits))
							{
								...
								double ye1 = 470.0 - (double)(coinrec.xpos(uidy1));
								double xo2 = (double)(coinrec.ypos(uidx2));
								double yo2 = (double)(coinrec.ypos(uidy2));
								hist2d[18].cumulate((xe1 - xo2), (ye1 - yo2));
							}
							    ...
							    coinrec.xy1cluster(uidy2, maxhits))
							{
								...
								double ye1 = 470.0 - (double)(coinrec.xpos(uidy1));
								double yo1 = 470.0 - (double)(coinrec.ypos(uidy1));
								double xa1 = (xe1 + xo1 + 5.0) * 0.5;
								double ya1 = (ye1 + yo1 + 5.0) * 0.5;
								...
								double yo2 = (double)(coinrec.ypos(uidy2));
								double xa2 = (xe2 + xo2 + 5.0) * 0.5;
								double ya2 = (ye2 + yo2 + 5.0) * 0.5;
								...
								if (histit)
								{
									...
									//
									// single plane dx-dx dy-dy
									hist2d[10].cumulate((xe1 - xo2), (xo1 - xe2));
									hist2d[11].cumulate((xe1 - xe2), (xo1 - xo2));
									hist2d[12].cumulate((ye1 - yo2), (yo1 - ye2));
									hist2d[13].cumulate((ye1 - ye2), (yo1 - yo2));
									//
									// single plane dx-dy
									hist2d[14].cumulate((xe1 - xo2), (ye1 - yo2));
									hist2d[15].cumulate((xe1 - xo2), (yo1 - ye2));
									hist2d[16].cumulate((xo1 - xe2), (ye1 - yo2));
									hist2d[17].cumulate((xo1 - xe2), (yo1 - ye2));
								}
							}
						}
					}
