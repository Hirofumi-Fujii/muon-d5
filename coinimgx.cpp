// coinimgx.cpp
// g++ -Wall coinimgx.cpp coinimgopt.cpp coinrecord.cpp gzfstream.cpp gzipfilebuf.cpp hist2d.cpp ncpng.cpp mytimer.cpp -lz -o coinimgx
//
					    ...
					    (recstr.substr(0,4) == "COIN"))
					{
						...
						if ((ss >> coinrec))
						{
							    ...
							    coinrec.xy1cluster(uidy2, maxhits))
							{
								...
								if (opt.m_xenarrow)
								{
									if ((xe1 < 237.5) || (xe2 < 237.5))
										histit = false;
									if ((xo1 < 237.5) || (xo2 < 237.5))
										histit = false;
								}
								if (opt.m_xonarrow)
								{
...
///// OUTPUT section /////
	...
	ofh
		<< "<!DOCTYPE html>\n"
		<< "<html>\n"
		<< "<head><title>coinimgx results</title></head>\n"
		<< "<body>\n"
		<< "<hr>\n<h1>coinimgx results</h1>\n<hr>\n"
		<< std::endl;
