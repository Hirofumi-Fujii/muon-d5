// genaccd5_360.cpp
//
// g++ -Wall genaccd5_360.cpp hist2d.cpp mytimer.cpp jokisch.cpp miyake.cpp ncpng.cpp -o genaccd5_360
//
// 2017-10-17 modified for d5-360
...
//			double wt1 = wt0 * cs2the;
	...
	// Show results.
	if (!outnamegiven)
		outname = std::string("genaccd5-360");
