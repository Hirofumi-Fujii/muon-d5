// genaccd5_660.cpp
//
// g++ -Wall genaccd5_660.cpp hist2d.cpp mytimer.cpp jokisch.cpp miyake.cpp ncpng.cpp -o genaccd5_660
//
// 2017-10-17 modified for d5-660
...
static const double UNIT_ZDIFF = 660.0;
...
//
static const int NUM_DETECTOR_PLANES = 8;	// YA-YB-XA-XB XB-XA-YB-YA for 1F2/1F3
...
//			double wt1 = wt0 * cs2the;
	...
	// Show results.
	if (!outnamegiven)
		outname = std::string("genaccd5-660");
